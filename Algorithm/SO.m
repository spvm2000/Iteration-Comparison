function Data_o = SO(Data_i,Data_o)
t_c=clock;                             
cnt=1;                                  
gbest_t=zeros(1,Data_i.maxIter);
%% Problem Definition
T = Data_i.maxIter;        
N = Data_i.pop;         
dim= Data_i.dim;               
...
if Q<Threshold
    ...
    if Ybest1<Ybest2
        gbest_t(t)=Ybest1;
        Data_o.Best_fitness(Data_i.now_fun_index,Data_i.now_test_iter) = Ybest1;
        Data_o.Best_Pos(Data_i.now_fun_index,Data_i.now_test_iter)=tempos;
    else
        gbest_t(t)=Ybest2;
        Data_o.Best_fitness(Data_i.now_fun_index,Data_i.now_test_iter) = Ybest2;
        Data_o.Best_Pos(Data_i.now_fun_index,Data_i.now_test_iter)=tempos+Nm;
    end
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Data_o.IterCurve(Data_i.now_fun_index,Data_i.now_test_iter,:)=gbest_t;
end
